...
public class SharedMenu extends BaseActivity {
    ...
    String bookingId;
     private RelativeLayout rlSharedMenu;
//    ListView menuList;
    ListView menuList;
    ...
    public void createActivity() {
        rlSharedMenu = (RelativeLayout)layoutInflater.inflate(R.layout.activity_shared_menu,null);
        llContent.addView(rlSharedMenu, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
        context = this;
        ivBack.setVisibility(View.VISIBLE);
        ivMenu.setVisibility(View.GONE);
        tvTitle.setText("Shared Menu");
...
//        menuList.setAdapter(hotelItemAdapter);
        ...
        sm_pager = (ViewPager) rlSharedMenu.findViewById(R.id.sm_pager);
...
//                sm_pager.setCurrentItem(tab.getPosition());
        ...
        tabs = (SlidingTabLayout) rlSharedMenu.findViewById(R.id.menutabs);
    ...
    private void assignActionstoView() {
        Button btnAddPerson = (Button) rlSharedMenu.findViewById(R.id.sm_btn_add_person);
        Button btnConfirmMenu = (Button) rlSharedMenu.findViewById(R.id.sm_btn_confirm_menu);
            ...
            public void done(List<ParseObject> hotelItemList, ParseException e) {
                if (e == null) {
                    ...
                    if(menuListMap!=null && menuListMap.size()>0)
                    {
                        ...
                        Set<String> keySet = menuListMap.keySet();
