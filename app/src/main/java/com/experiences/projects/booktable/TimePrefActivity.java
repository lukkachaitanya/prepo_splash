...
public class TimePrefActivity extends BaseActivity {
    ...
    public int s = 0;
    private RelativeLayout rlTimePref;
    SharedPreferences.Editor myPrefEditor;

    @Override
    public void createActivity() {
        rlTimePref = (RelativeLayout)layoutInflater.inflate(R.layout.activity_time_pref,null);
        llContent.addView(rlTimePref, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
        context = this;
        ivBack.setVisibility(View.VISIBLE);
        ivMenu.setVisibility(View.GONE);
        tvTitle.setText("Time Pref");
        context = this;
        ...
        Button request_table_btn = (Button) rlTimePref.findViewById(R.id.continue_button);
    ...
    private void setImage(String hotelName, String pic) {
        View main_header_view = rlTimePref.findViewById(R.id.venue_header);
    ...
    private void showPeopleChooser() {
        ImageButton people_up_btn = (ImageButton) rlTimePref.findViewById(R.id.people_up_button);
        ImageButton people_down_btn = (ImageButton) rlTimePref.findViewById(R.id.people_down_button);
        final TextView people_text = (TextView) rlTimePref.findViewById(R.id.people_text);
    ...
    private void showDateChooser() {
        ImageButton date_up_btn = (ImageButton) rlTimePref.findViewById(R.id.date_up_button);
        ImageButton date_down_btn = (ImageButton) rlTimePref.findViewById(R.id.date_down_button);
        final TextView date_text_view = (TextView) rlTimePref.findViewById(R.id.date_text);
    ...
    private void showTimeChooser() {
        ImageButton late_time_up_btn = (ImageButton) rlTimePref.findViewById(R.id.late_time_up_button);
        ImageButton late_time_down_btn = (ImageButton) rlTimePref.findViewById(R.id.late_time_down_button);
        final TextView late_time_text_view = (TextView) rlTimePref.findViewById(R.id.late_time_text);
