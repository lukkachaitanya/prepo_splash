...
public class HotelProfileActivity extends BaseActivity {

    Context context;
    private HotelMenuListAdapter hotelItemAdapter;
    private RelativeLayout rlHotelProfile;
    @Override
    public void createActivity() {

        rlHotelProfile = (RelativeLayout)layoutInflater.inflate(R.layout.activity_hotel_profile,null);
        llContent.addView(rlHotelProfile, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
        context = this;
        ivBack.setVisibility(View.VISIBLE);
        ivMenu.setVisibility(View.GONE);
        tvTitle.setText("Hotel Profile");
    ...
    private void fillHotelInfo(final ParseObject hotel) {
        ...
        View venu_image_view = (View) rlHotelProfile.findViewById(R.id.include_venue_image);
        ...
        TextView tv_hotel_name = (TextView) rlHotelProfile.findViewById(R.id.venue_info_text);
        tv_hotel_name.setText(name);

        TextView tv_hotel_desc = (TextView) rlHotelProfile.findViewById(R.id.venue_description);
        tv_hotel_desc.setText(desc);

        TextView tv_hotel_loc = (TextView) rlHotelProfile.findViewById(R.id.address_label);
        tv_hotel_loc.setText(location);


        Button btn_confirm = (Button) rlHotelProfile.findViewById(R.id.continue_button);
